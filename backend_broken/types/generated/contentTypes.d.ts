...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Author: Schema.Attribute.Relation<'oneToMany', 'api::project.project'>;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Category: Schema.Attribute.Relation<'oneToMany', 'api::project.project'>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    published_att: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    reading_time: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<5>;
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    status_at: Schema.Attribute.Enumeration<['draft', 'published', 'archived']>;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status_at: Schema.Attribute.Enumeration<
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    Tag: Schema.Attribute.Relation<'manyToMany', 'api::project.project'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
