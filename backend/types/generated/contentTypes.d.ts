...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content type optimis\u00E9 pour un blog professionnel avec SEO complet';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    schema: Schema.Attribute.Component<'schema.structured-data', false>;
    seo: Schema.Attribute.Component<'seo.seo-data', false>;
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    status: Schema.Attribute.Enumeration<['draft', 'published', 'scheduled']> &
      Schema.Attribute.Required &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Cat\u00E9gories d'articles avec SEO optimis\u00E9";
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content type pour les projets avec SEO optimis\u00E9 et portfolio professionnel';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    language: Schema.Attribute.Enumeration<['fr', 'en']> &
      Schema.Attribute.DefaultTo<'fr'>;
    lessons_learned: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    project_type: Schema.Attribute.Enumeration<
      ['web-app', 'mobile-app', 'api', 'library', 'tool', 'website', 'other']
    > &
      Schema.Attribute.Required &
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tags pour la taxonomie des articles';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
